...
export default function Header() {
    return (
        <div className="h-100 bg-primary font-all sm:rounded-none sm:shadow-none lg:h-150">
            ...
            <div className="flex flex-col text-secundary px-8 pt-10 sm:items-center sm:pt-5">
                <div>
                    <p className="text-base -mb-4 xs:text-xl lg:text-3xl">Olá, me chamo João👋</p>
                    <div className="flex flex-row">
                        <h1 className="font-extrabold drop-shadow-3xl text-1hl xs:text-2hl sm:text-3hl lg:text-4hl">Fullstack</h1>
                        <div className="flex flex-row pt-2 ml-1 xs:pt-3 xs:ml-0.5 lg:pt-5.5">
                            <Image
                ...
                <div className="flex flex-col items-center -mt-6 sm:-mt-10 lg:-mt-14">
                    <h1 className="text-center font-extrabold pr-6 drop-shadow-3xl text-1hl xs:text-2hl sm:text-3hl lg:text-4hl xs:pr-4 sm:pr-10 lg:pr-14">Developer</h1>
